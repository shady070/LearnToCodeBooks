        ...
        recentPosts.map((post, index) => (
          <motion.div initial={{ opacity: 0, x:-100 }} whileInView={{ opacity: 1, x:0 }} transition={{ delay: 0.2, duration:0.6 }} className="hover:drop-shadow-2xl" key={index}>
            ...
            <div className='w-full md:w-[330px] h-[176px] rounded-b-lg px-[31px] pt-[8px] bg-[#1B222C] text-white mb-[30px] md:mb-[0px]'>
              <motion.h1 initial={{ opacity: 0, y:20 }} whileInView={{ opacity: 1, y:0 }} transition={{ delay: 0.4, duration:0.5 }} className='text-[20px] font-medium pb-[5px] text-white hover:text-[#FB8B01] active:text-[#FB7712] cursor-pointer '>{post.acf.title}</motion.h1>
