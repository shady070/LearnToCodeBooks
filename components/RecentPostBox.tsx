    ...
    <div className="md:flex md:gap-[50px] flex-wrap">
      {loading ? (
        ...
        recentPosts.map((post) => (
          <div className="hover:drop-shadow-2xl" key={post.id}>
            <div>
              <img
            ...
            <div className="w-full md:w-[330px] h-[111px] rounded-b-lg px-[31px] pt-[8px] bg-[#1B222C] text-white mb-[30px] md:mb-[0px]">
              <Link href={`/details/${post.id}`} className="text-[20px] font-medium pb-[11px] text-white cursor-pointer hover:text-[#FB8B01] active:text-[#FB7712]">
                {post.acf.title}
              </Link>
